...
INSERT INTO "new_Address" ("city", "complement", "country", "createdAt", "customerId", "id", "isPrimary", "number", "postalCode", "state", "street", "updatedAt") SELECT "city", "complement", "country", "createdAt", "customerId", "id", "isPrimary", "number", "postalCode", "state", "street", "updatedAt" FROM "Address";
DROP TABLE "Address";
